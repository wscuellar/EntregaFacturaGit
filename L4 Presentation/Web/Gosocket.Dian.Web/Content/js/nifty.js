...
!function ($) {
    ...
    nifty.document.on('nifty.ready', function () {
        ...
        $('.nano').each(function () {
            $(this).nanoScroller({ alwaysVisible: true, preventPageScrolling: true });
        ...
        $('#navbar-container .navbar-top-links').on('shown.bs.dropdown', '.dropdown', function () {
            $(this).find('.nano').nanoScroller({ preventPageScrolling: true, alwaysVisible: true });
        });
