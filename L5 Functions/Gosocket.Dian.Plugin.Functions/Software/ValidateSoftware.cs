...
namespace Gosocket.Dian.Plugin.Functions.Software
{
    public static class ValidateSoftware
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            try
            {
                var validateResponses = await ValidatorEngine.Instance.StartSoftwareValidationAsync(trackId);
            ...
            catch (Exception ex)
            {
                ...
                var validateResponses = new List<ValidateListResponse>
                {
                    new ValidateListResponse
                    {
                        ...
                        Mandatory = true,
                        ErrorCode = "SOFTPLGNS",
                        ErrorMessage = $"No se pudo validar software."
                    }
                };
