...
namespace Gosocket.Dian.Services.Utils.Cryptography.XmlDsig
{
    ...
    public class XmlAdvancedElectronicSignature2 : ValidXmlDocument
    {
        ...
        {
            System.Security.Cryptography.X509Certificates.X509Certificate2 cert2 = new System.Security.Cryptography.X509Certificates.X509Certificate2(path, Password, X509KeyStorageFlags.Exportable | X509KeyStorageFlags.PersistKeySet);
            RSACryptoServiceProvider sp = (RSACryptoServiceProvider)cert2.PrivateKey;
            RSAParameters pars = sp.ExportParameters(true);
            byte[] buf = null;
            int size = 0;
